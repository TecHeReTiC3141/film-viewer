                ...
                (
                    <>
                        ...
                        <Link to="/"
                              ...
                              gap-2 mt-2 rounded-full p-3 bg-blue-500 hover:bg-blue-600"><FaArrowLeft/> На главную</Link>
                    </>
                ) : <>
                    ...
                    <button className="flex items-center text-lg text-gray-200 hover:text-white shadow-lg
                              gap-2 mt-2 rounded-full p-3 bg-blue-500 hover:bg-blue-600" onClick={() => navigate(0)}>Обновить страницу</button>
                </>}
